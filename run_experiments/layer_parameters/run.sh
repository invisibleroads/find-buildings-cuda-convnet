...
# ccn-train layers-18pct/options.cfg
# ccn-train layers-19pct/options.cfg
# ccn-train layers-80sec/options.cfg
# ccn-train layers-conv-local-11pct/options.cfg
# ccn-train layers-conv-local-13pct/options.cfg
