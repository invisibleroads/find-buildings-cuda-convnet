...
class ImageScope(SatelliteImage):
    ...
    def yield_pixel_upper_left(self, interval_pixel_dimensions):
    ...
    def save_array_from_upper_left(self, target_path, upper_left):
        pixel_upper_left = self.to_pixel_xy(upper_left)
        return self.save_array_from_pixel_upper_left(
            target_path, pixel_upper_left)

    def save_array_from_pixel_upper_left(self, target_path, pixel_upper_left):
